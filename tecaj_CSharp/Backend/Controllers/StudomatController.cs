...
{
    public abstract class StudomatController<T, TDR, TDI>(StudomatContext context) : ControllerBase where T : Entitet
    {
        ...
        protected readonly StudomatContext _context = context;
